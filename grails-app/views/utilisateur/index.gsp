...
<div id="list-utilisateur" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="dateDeNaissance"
                              title="${message(code: 'utilisateur.dateDeNaissance.label', default: 'Date De Naissance')}"/>
        ...
        <g:each in="${utilisateurInstanceList}" status="i" var="utilisateurInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:formatDate date="${utilisateurInstance.dateDeNaissance}"/></td>
